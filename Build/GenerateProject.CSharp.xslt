...
<xsl:stylesheet
  ...
  <xsl:template name="profile_and_version"
    ...
    <xsl:if test="$root/Input/Generation/Platform = 'MacOS' and $root/Input/Properties/UseXamMacFull">
      <UseXamMacFullFramework><xsl:value-of select="$root/Input/Properties/UseXamMacFull" /></UseXamMacFullFramework>
    </xsl:if>
  </xsl:template>
